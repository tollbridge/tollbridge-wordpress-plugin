<div amp-access="<?= implode(' AND ', array_map(function ($plan) {
    return 'plan != ' . $plan;
}, array_column($plans, 'id'))) ?> AND (views < 0 OR type = 'hard') AND widget.style = 'overlay'">
    <template amp-access-template type="amp-mustache">
        <div class="absolute h-screen w-screen left-0 z-10000">
            <div data-ref="wrapper" class="w-screen fixed left-0 bottom-0 flex items-center px-8 z-10000 h-screen"
                 style="background: rgba(0, 0, 0, 0.7);">
                <div class="bg-white border-1 border-gray-300 shadow-xl rounded-lg overflow-hidden w-full mx-auto max-w-lg">
                    <div class="px-8  py-8"><h3 class="text-xl leading-6 font-medium text-gray-800"> {{ widget.title
                            }} </h3>
                        <div class="mt-6 tracking-wide text-lg leading-5 text-gray-700 max-w-xl"><p> {{ widget.body
                                }} </p>
                        </div>
                        <div class="mt-4">
                           ...
                           class="w-full flex text-gray-400 items-center justify-center mt-8 text-sm {{ widget.hide_tollbridge_branding }}"> Powered by
                            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path d="M17.09,33.74a.86.86,0,0,0-.86.87V53.83a.86.86,0,0,0,1.25.77,67.17,67.17,0,0,1,7.67-3.2.86.86,0,0,0,.59-.81v-16a.87.87,0,0,0-.87-.87Z"
                                      class="cls-2"></path>
                                <path d="M7.71,69.07a45,45,0,0,0,77.62.05A58.82,58.82,0,0,0,7.71,69.07Z"
                                      class="cls-2"></path>
