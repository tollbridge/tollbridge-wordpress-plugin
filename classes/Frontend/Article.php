...
class Article
{
    ...
    private function articleIsSetToOpenToAll()
    {
    ...
    {
        return intval(trim($this->meta['tollbridge_paywall_eligibility_check_behaviour']) ?? Manager::PAYWALL_ELIGIBILITY_BEHAVIOR_OPEN_TO_USERS_WITH_CONFIGURED_PLANS);
    }
}
